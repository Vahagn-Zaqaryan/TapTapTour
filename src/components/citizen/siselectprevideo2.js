            ...
            <div className="box">
                <header>
                    <div className="header-box">
                        <h1 className="">
                            WALK TO A NEARBY METRO STATION! TAKE THE METRO & GET OFF AT BAGHRAMYAN METRO STATION! WALK DOWN TO THE PARLIAMENT! WATCH HOW THE PROTESTERS FACE THE POLICE IN FRONT OF THE PARLIAMENT BUILDING<span>!</span>
                        </h1>
                    </div>
                </header>
                <main>
